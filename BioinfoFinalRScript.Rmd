...
p-value = 0.0002412
```{r}
original <- read.table(file="c:/Users/Autumn/Downloads/imageResult/results-dataset-no-rotation.tsv", header=TRUE, sep="\t")
print(original)
...
ninetyRotation <- read.table(file="c:/Users/Autumn/Downloads/imageResult/results-dataset-90.tsv", header=TRUE, sep="\t")
...
```{r}
oneEightyRotation <- read.table(file="c:/Users/Autumn/Downloads/imageResult/results-dataset-180.tsv", header=TRUE, sep="\t")
...
```{r}
twoSeventyRotation <- read.table(file="c:/Users/Autumn/Downloads/imageResult/results-dataset-270.tsv", header=TRUE, sep="\t")
...
```{r}
dataModel <- read.table(file="c:/Users/Autumn/Downloads/imageResult/results-dataset-model-47398.tsv", header=TRUE, sep="\t")
print(dataModel)
...
```{r}
dataModelNew <- read.table(file="c:/Users/Autumn/Downloads/imageResult/results-new-images.tsv", header=TRUE, sep="\t")
print(dataModelNew)
...
```{r}
df <- read.table(file="c:/Users/Autumn/Downloads/imageResult/original.tsv", header=TRUE, sep="\t")
print(df)
straightDF <- df[,2]
...
```{r}
dfModel <- read.table(file="c:/Users/Autumn/Downloads/imageResult/model.tsv", header=TRUE, sep="\t")
print(dfModel)
...
```{r}
dfNew <- read.table(file="c:/Users/Autumn/Downloads/imageResult/new.tsv", header=TRUE, sep="\t")
print(dfNew)
